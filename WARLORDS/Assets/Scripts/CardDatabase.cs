...
public class CardDatabase : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cardList.Add(new Card(10, "Fake Injury", 0, 0, 0, "Fake injury to lull your enemy into a false sense of security. When your enemy targets one of your injured units heal that unit to full", Resources.Load<Sprite>("11"), "Red", Card.CardFaction.CHINESE, Card.CardType.TRAP));
        cardList.Add(new Card(11, "Land Mine", 0, 0, 0, "When an enemy movessssssss, reveal this card and deal 100 damage to the enemy unit", Resources.Load<Sprite>("12"), "Blue", Card.CardFaction.CHINESE, Card.CardType.TRAP));
